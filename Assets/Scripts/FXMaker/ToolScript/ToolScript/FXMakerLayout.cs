...
[AddComponentMenu("FXMaker/ToolScript/FXMakerLayout")]
public class FXMakerLayout : NgLayout
{
	...
	public		const string	m_CurrentVersion			= "v1.15";
	...
	// 谅钎沥焊
#if UNITY_EDITOR
	public		static float	GetFixedWindowWidth()		{ return UnityEditor.EditorPrefs.GetFloat("FXMakerOption.m_fFixedWindowWidth", 115); }
	public		static float	GetTopMenuHeight()			{ return (m_bMinimizeAll||m_bMinimizeTopMenu ? m_MinimizeHeight : UnityEditor.EditorPrefs.GetFloat("FXMakerOption.m_fTopMenuHeight", 92)); }
#else
