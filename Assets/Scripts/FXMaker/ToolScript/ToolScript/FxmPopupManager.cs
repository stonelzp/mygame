...
[AddComponentMenu("FXMaker/ToolScript/FxmPopupManager")]
	...
	public void ShowHierarchyObjectPopup(string scriptFilename, Object selObj)
	{
		if (scriptFilename != null)
		{
			...
			if (m_CurrentHierarchyPopup == null)
				m_CurrentHierarchyPopup	= UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(m_ToolPopupGameObject, "Assets/Scripts/FXMaker/ToolScript/ToolScript/FxmPopupManager.cs (396,31)", scriptFilename) as FxmPopup;
			if (m_CurrentHierarchyPopup != null)
