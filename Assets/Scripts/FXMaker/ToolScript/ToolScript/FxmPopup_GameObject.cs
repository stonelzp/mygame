...
[AddComponentMenu("FXMaker/ToolScript/FxmPopup_GameObject")]
...
// 		FXMakerMain.inst.ToggleGlobalLangSkin(false);
	...
	void LoadScriptList()
	{
		...
		// load folder
		string[] groupStrings		= {"FXMaker/NcEffect", "Unity"}; //nFindFolderCount = groupStrings.Length; //NgAsset.GetFolderList(scriptDir, null, "Hide", 0, out nFindFolderCount);
...
// 					continue;
	...
	{
		Component com = UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(m_SelectedTransform.gameObject, "Assets/Scripts/FXMaker/ToolScript/ToolScript/FxmPopup_GameObject.cs (229,19)", scriptName);
		if (com != null)
		{
