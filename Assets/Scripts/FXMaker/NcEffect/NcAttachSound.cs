...
[AddComponentMenu("FXMaker/NcEffect/NcAttachSound")]
public class NcAttachSound : NcEffectBehaviour
{
	...
	{
		if ((enabled && gameObject.activeSelf) || (m_AudioSource != null && m_AudioSource.isPlaying))
			return 1;
// 		if ((enabled && gameObject.activeSelf) && m_AudioClip != null &&
