...
[AddComponentMenu("FXMaker/NcEffect/NcAttachPrefab")]
public class NcAttachPrefab : NcEffectBehaviour
{
	...
	{
		if ((enabled && gameObject.activeSelf) && m_AttachPrefab != null)
		{
...
#endif
		m_bEnabled = (enabled && gameObject.activeSelf && GetComponent<NcDontActive>() == null);
...
//		Ng_ChangeLayerWithChild(m_CreateGameObject, gameObject.layer);
		...
		m_CreateGameObject.SetActive(true);
