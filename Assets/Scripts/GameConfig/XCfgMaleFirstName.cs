...
partial class XCfgMaleFirstNameMgr : CCfgListMgrTemplate<XCfgMaleFirstNameMgr, XCfgMaleFirstName> { };

partial class XCfgMaleFirstName : ITabItem
{
	...
	public string FirstName { get; private set; }				// 男名

	public XCfgMaleFirstName()
	{
	}
