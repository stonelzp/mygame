...
partial class XCfgBagSpaceMgr : CCfg1KeyMgrTemplate<XCfgBagSpaceMgr, uint, XCfgBagSpace> { };

partial class XCfgBagSpace : ITabItemWith1Key<uint>
{
	...
	public uint SlotID { get; private set; }				// 背包槽ID
