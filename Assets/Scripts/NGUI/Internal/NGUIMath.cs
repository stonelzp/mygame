...
static public class NGUIMath
{
	...
	static public Bounds CalculateRelativeWidgetBounds (Transform root, Transform child, bool bIncludeInactive)
	{
		UIWidget[] widgets = child.GetComponentsInChildren<UIWidget>(bIncludeInactive) as UIWidget[];
	...
	static public Bounds CalculateRelativeWidgetBounds (Transform trans, bool bIncludeInactive)
	{
		return CalculateRelativeWidgetBounds(trans, trans, bIncludeInactive);
	}
	
	static public Bounds CalculateRelativeWidgetBounds (Transform trans)
	{
		return CalculateRelativeWidgetBounds(trans, false);
	}
