...
public class UITable : MonoBehaviour
{
	...
	public bool m_repositionNow = false;
	public bool m_bModify_X = false;
	
	private UITable m_Table = null;
	
	//table reposition parent table reposition too
		...
		set{
			...
			if( true == value)
			{
				if (m_Table == null)
				{
					...
					{
						m_Table = NGUITools.FindInParents<UITable>(transform.parent.gameObject);
					}
