...
public class UICheckbox : MonoBehaviour
{
	...
	public delegate void AfterActive (bool state);
	...
	public UILabel checkBoxText;//add
	...
	/// 文字选中时的颜色
	/// </summary>
	public Color CheckColor = Color.yellow;
	...
	void Awake ()
	{
		...
		if (checkBoxText != null) checkBoxText.color = startsChecked ? CheckColor : UnCheckColor;
	...
	void Set (bool state)
	{
		if (!mStarted)
		{
			...
			if(checkBoxText != null) checkBoxText.color = state ?  CheckColor : UnCheckColor;
			// Notify the delegate
