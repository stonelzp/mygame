...
public class UIImageButtonInspector : Editor
{
	...
	public override void OnInspectorGUI ()
	{
		...
		GameObject tipObj = (GameObject)EditorGUILayout.ObjectField("Tip", mButton.TipObject, typeof(GameObject), true);
		
		string CommonTips = (string)EditorGUILayout.TextField("CommonTips", mButton.CommonTips);
		if ( tipObj != mButton.TipObject )
		{
			mButton.TipObject = tipObj;
		}
		
		if(CommonTips != mButton.CommonTips)
		{
			mButton.CommonTips = CommonTips;
		}
